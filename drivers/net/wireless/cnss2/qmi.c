...
void cnss_get_filename(char *filename, u32 filename_len, int pj_id, int hw_id,
		       int rf_id, int tempstr)
{
	if (pj_id == 11) {
		if (hw_id == 11 || hw_id == 33) {
			...
			case 11:
				cnss_pr_dbg(
					"it is China T0 version, begin to load the China BDF file");
				if (tempstr == 1)
					snprintf(
			...
			case 12:
				cnss_pr_dbg(
					"it is TMO T0 version, begin to load the TMO BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
			...
			case 13:
				cnss_pr_dbg(
					"it is INDIA T0 version, begin to load the INDIA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
			...
			case 21:
				cnss_pr_dbg(
					"it is Europe T0 version, begin to load the Europe BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
			...
			case 22:
				cnss_pr_dbg(
					"it is AMERICA T0 version, begin to load the AMERICA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
			...
			case 11:
				cnss_pr_dbg(
					"it is China EVT1 version, begin to load the China BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_CHINA_CHAIN0_ONLY_BDF);
			...
			case 12:
				cnss_pr_dbg(
					"it is TMO EVT1 version, begin to load the TMO BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P815_TMO_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 13:
				cnss_pr_dbg(
					"it is INDIA EVT1 version, begin to load the INDIA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_INDIA_CHAIN0_ONLY_BDF);
			...
			case 21:
				cnss_pr_dbg(
					"it is Europe EVT1 version, begin to load the Europe BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_EUROPE_CHAIN0_ONLY_BDF);
			...
			case 22:
				cnss_pr_dbg(
					"it is AMERICA EVT1 version, begin to load the AMERICA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_AMERICA_CHAIN0_ONLY_BDF);
			...
			case 11:
				cnss_pr_dbg(
					"it is China EVT2 version, begin to load the China BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_CHINA_CHAIN0_ONLY_BDF);
			...
			case 12:
				cnss_pr_dbg(
					"it is TMO EVT2 version, begin to load the TMO BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P815_TMO_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 13:
				cnss_pr_dbg(
					"it is INDIA EVT2 version, begin to load the INDIA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_INDIA_CHAIN0_ONLY_BDF);
			...
			case 21:
				cnss_pr_dbg(
					"it is Europe EVT2 version, begin to load the Europe BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_EUROPE_CHAIN0_ONLY_BDF);
			...
			case 22:
				cnss_pr_dbg(
					"it is AMERICA EVT2 version, begin to load the AMERICA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_AMERICA_CHAIN0_ONLY_BDF);
			...
			case 11:
				cnss_pr_dbg(
					"it is China DVT version, begin to load the China BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_CHINA_CHAIN0_ONLY_BDF);
			...
			case 12:
				cnss_pr_dbg(
					"it is TMO DVT version, begin to load the TMO BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P815_TMO_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 13:
				cnss_pr_dbg(
					"it is INDIA DVT version, begin to load the TMO INDIA file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_INDIA_CHAIN0_ONLY_BDF);
			...
			case 21:
				cnss_pr_dbg(
					"it is Europe DVT version, begin to load the Europe BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_EUROPE_CHAIN0_ONLY_BDF);
			...
			case 22:
				cnss_pr_dbg(
					"it is AMERICA DVT version, begin to load the AMERICA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_AMERICA_CHAIN0_ONLY_BDF);
			...
			case 11:
				cnss_pr_dbg(
					"it is China PVT version, begin to load the China BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_CHINA_CHAIN0_ONLY_BDF);
			...
			case 12:
				cnss_pr_dbg(
					"it is TMO PVT version, begin to load the TMO BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P815_TMO_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 13:
				cnss_pr_dbg(
					"it is INDIA PVT version, begin to load the INDIA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_INDIA_CHAIN0_ONLY_BDF);
			...
			case 21:
				cnss_pr_dbg(
					"it is Europe PVT version, begin to load the Europe BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_EUROPE_CHAIN0_ONLY_BDF);
			...
			case 22:
				cnss_pr_dbg(
					"it is AMERICA PVT version, begin to load the AMERICA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P815_PUBLIC_AMERICA_CHAIN0_ONLY_BDF);
		...
		if (hw_id == 11) {
			...
			case 23:
				cnss_pr_dbg(
					"it is VZW T0 version, begin to load the VZW BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
			...
			case 11:
				cnss_pr_dbg(
					"it is China EVT version, begin to load the China BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P825_PUBLIC_CHINA_CHAIN0_ONLY_BDF);
			...
			case 12:
				cnss_pr_dbg(
					"it is TMO EVT version, begin to load the TMO BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P80A_TMO_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 13:
				cnss_pr_dbg(
					"it is INDIA EVT version, begin to load the INDIA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P825_PUBLIC_INDIA_CHAIN0_ONLY_BDF);
			...
			case 21:
				cnss_pr_dbg(
					"it is Europe EVT version, begin to load the Europe BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P80A_PUBLIC_EUROPE_CHAIN0_ONLY_BDF);
			...
			case 22:
				cnss_pr_dbg(
					"it is AMERICA EVT version, begin to load the AMERICA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P80A_PUBLIC_AMERICA_CHAIN0_ONLY_BDF);
			...
			case 23:
				cnss_pr_dbg(
					"it is VZW EVT version, begin to load the VZW BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P80A_VZW_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 12:
				cnss_pr_dbg(
					"it is TMO EVT3 version, begin to load the TMO BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P80A_TMO_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 13:
				cnss_pr_dbg(
					"it is INDIA DVT version, begin to load the INDIA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P825_PUBLIC_INDIA_CHAIN0_ONLY_BDF);
			...
			case 21:
				cnss_pr_dbg(
					"it is Europe EVT3 version, begin to load the Europe BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P80A_PUBLIC_EUROPE_CHAIN0_ONLY_BDF);
			...
			case 22:
				cnss_pr_dbg(
					"it is AMERICA EVT3 version, begin to load the AMERICA BDF file");
				if (tempstr == 1)
					snprintf(
						filename, filename_len,
						P80A_PUBLIC_AMERICA_CHAIN0_ONLY_BDF);
			...
			case 23:
				cnss_pr_dbg(
					"it is VZW EVT3 version, begin to load the VZW BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P80A_VZW_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 23:
				cnss_pr_dbg(
					"it is VZW PVT version, begin to load the VZW BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P80A_VZW_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
			...
			case 23:
				cnss_pr_dbg(
					"it is VZW DVT version, begin to load the VZW BDF file");
				if (tempstr == 1)
					snprintf(filename, filename_len,
						 P80A_VZW_CHAIN0_ONLY_BDF);
				else if (tempstr == 2)
...
#endif
	cnss_pr_dbg("PRJ_ID: %d, HW_ID: %d, RF_ID: %d\n", pj_id, hw_id, rf_id);

	switch (bdf_type) {
	case CNSS_BDF_ELF:
		/* Board ID will be equal or less than 0xFF in GF mask case */
		if (plat_priv->board_info.board_id == 0xFF) {
			cnss_get_filename(filename, filename_len, pj_id, hw_id,
					  rf_id, tempstr);
			return ret;
...
int cnss_atoi(const char *numbers)
{
	...
	if (length == 3) {
		sum = (numbers[0] - 'a' + 10) * cnss_pow_ten(3) +
		      (numbers[1] - '0') * cnss_pow_ten(2) + numbers[2] - 'a' +
		      10;
	} else {
		for (i = 0; i < length; i++) {
